...
[GRCh38 mitochondrial DNA](https://www.ncbi.nlm.nih.gov/nuccore/NC_012920.1). SNPs are
...
The PNG file was exported from [macSVG](https://github.com/dsward2/macsvg/).

The color scheme was generated by [ColorBrewer](http://colorbrewer2.org/).

## SNPs

The SNPs highlighted in the banner were identified with the
[UCSC Genome Browser](https://genome.ucsc.edu/). The dbSNP accessions for the SNPs are as
follows:
